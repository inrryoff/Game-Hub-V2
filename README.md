...
- **⚡ Compatibilidade:** Testado apenas no **Moto G24** porém presuma-se que seja compatível com o **Moto G24 Power** e dispositivos com SoC **mt6768 & mt6769** (Hélio G80/G85).*
...
Abra uma issue no GitHub com:
  - Modelo do celular- ROM (Stock/GSI)
...
1. Este módulo funciona em simbiose com o *ZramTG24* e o *BuSy.* É **obrigatória** a instalação dos módulos abaixo:
     ...
     - 👉 **Conheça - [NeonX](https://github.com/inrryoff/Neonx)**
     ...
     - O GameHub-PRO-X ja vem com o binario do **NeonX** para colorir seus banners com rgb e também fazer uma animação de `spiner` colorido para uma experincia de UX agradavel
...
3. Vá na aba de módulos.4. Selecione instalar do armazenamento.
4. selecione o arquivo do GameHub-PRO-X.6. Reinicie o dispositivo.
...
## 🙏 Agradecimentos
   ...
   - Terminal emulador para Android (GPL v3.0)
